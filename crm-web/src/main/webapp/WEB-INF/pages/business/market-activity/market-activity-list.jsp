...
<%--		</span>--%>
        日期范围：
        <input type="text" placeholder="开始日期" autocomplete="off" onfocus="WdatePicker({  })"
               id="logmin"
               class="input-text Wdate" style="width:120px;">
        -
        <input type="text" placeholder="结束日期" autocomplete="off" onfocus="WdatePicker({ })"
               id="logmax"
               class="input-text Wdate" style="width:120px;">
        <input type="text" name="" id="" placeholder="名称" style="width:100px" class="input-text">
        <input type="text" name="" id="" placeholder="所有者" style="width:100px" class="input-text">
        <button style="margin-left: 15px" name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i>查询</button>
    </div>
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
                                                               class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a
            class="btn btn-primary radius" data-title="创建市场活动" data-href="business/market-activity-add"
            onclick="Hui_admin_tab(this)"
            href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>创建市场活动</a></span> <span
